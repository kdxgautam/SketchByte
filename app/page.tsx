        ...
        <nav className="relative  p-4 max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
          <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <h1 className="text-2xl flex-none text-[#007dfc] font-semibold ">SketchByte</h1>
              {/* </button> */}
            </div>
          </div>
        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
          ...
          <div className="mt-5 max-w-2xl text-center mx-auto">
            <h1 className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
              Build Something
              <span className="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent"> With SketchByte</span>
            </h1>
          </div>
          ...
          <div className="mt-5 max-w-3xl text-center mx-auto">
            <p className="text-lg text-gray-600 dark:text-neutral-400">
              Revolutionize your website creation with our AI-powered app, delivering your sketches to code in seconds.</p>
          </div>
